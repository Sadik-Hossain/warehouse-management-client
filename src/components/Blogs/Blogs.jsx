      ...
      <div style={{ padding: "0 2rem" }}>
        <div className="ans-card">
          ...
          <p style={{ fontSize: "1.5rem" }}>
            ...
            of modules and mostly used in server-side.
          </p>
          <p style={{ fontSize: "1.5rem" }}>
            <span className="detail-text">JavaScript : </span>
            Javascript is a high-level,multi-paradigm programming language. that
            is used for writing scripts on the website. it's capable enough to
            add HTML and play with the DOM. Mainly used on clientside.
          </p>
        </div>
        <div className="ans-card">
          <h1>
          ...
          <p style={{ fontSize: "1.5rem" }}>
            ...
            access requests easily. There are 2 design patterns in programming.
            One is asynchronous programming and the other is synchronous
            programming. Node JS by default follows the Asynchronous pattern.
            That is, it does not wait for a task to be completed. In the
            meantime, NodeJS started another job. That's why we use nodeJS.
          </p>
        </div>
        <div className="ans-card">
